...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<form class="input-group col-md-8 col-md-offset-2" action="process.php" method="post">
			...
			<input type="hidden" name="app_status_id" class="form-control input-md col-md-3" value="done">
			<input id="btn-input" type="text" class="form-control input-md alert-info" name="Cancellation" placeholder="Are You Sure to End Appointment?" style="cursor: default;" disabled="">
			<span class="input-group-btn">
				<input type="submit" class="btn btn-info btn-md" name="doneapp" value="End Appointment">
			</span>
		</form>
	</div>
